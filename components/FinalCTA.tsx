    ...
    <section className="py-40 bg-[#050505] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-20">
        <h2 className="text-5xl lg:text-8xl font-bold text-white mb-8 tracking-tighter leading-[0.9]">
          ...
          <span className="text-[#F3CEA1]">seu escritório?</span>
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button className="w-full sm:w-auto px-12 py-6 bg-[#F3CEA1] text-black rounded-2xl font-bold text-xl hover:bg-[#E5BE90] transition-all hover:scale-105 shadow-[0_0_40px_rgba(243,206,161,0.2)]">
             Adquirir Agora
          </button>
        </div>
