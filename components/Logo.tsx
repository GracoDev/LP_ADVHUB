export default function Logo({ className = "w-40 h-auto" }: { className?: string }) {
  return (
    <svg 
      ...
      viewBox="0 0 640.1 133.01" 
      className={className}
      aria-label="AdvHub Logo"
    >
      <defs>
        <style>{`
          .cls-1 { fill: #fed094; }
          .cls-2 { fill: url(#Gradiente_sem_nome_4); }
          .cls-3 { fill: #ffffff; } /* Mudado para branco puro para contraste */
        `}</style>
